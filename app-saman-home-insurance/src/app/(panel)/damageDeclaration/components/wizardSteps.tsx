...
const WizardSteps = (props: PropsType) => {
  ...
  return (
    <div className="flex items-center justify-center gap-x-2 py-6 w-full overflow-x-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
      <div className="flex items-center gap-x-2 min-w-max px-4">
